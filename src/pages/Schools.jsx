...
export default function Schools() {
  return (
    <div className="pt-20">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {stats.map((s, i) => (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className={`rounded-3xl p-8 transition-shadow duration-300 ${s.highlight
                  ? 'bg-gradient-to-br from-primary-600 to-primary-700 text-white shadow-glow-lg'
                  : 'bg-slate-50 border border-slate-100 hover:shadow-card'
                }`}
              >
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="max-w-7xl mx-auto bg-white/92 backdrop-blur-sm rounded-[2.5rem] border border-white/70 shadow-2xl p-6 sm:p-10 md:p-14 grid lg:grid-cols-2 gap-16 items-center">
