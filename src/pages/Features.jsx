...
export default function Features() {
  return (
    <div className="pt-20">
      ...
      />
      {/* Hero */}
      <section className="py-24 px-4 bg-gradient-to-br from-primary-50 via-white to-blue-50">
        <div className="max-w-4xl mx-auto text-center">
          <div className="section-label mb-6">Platform Features</div>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mainFeatures.map((f) => (
              <div key={f.title} className="card card-hover group border border-slate-100">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {howItWorks.map(({ step, title, desc }) => (
              <div key={step} className="relative">
                <div className="w-14 h-14 rounded-2xl bg-primary-600 text-white font-display font-bold text-xl flex items-center justify-center mx-auto mb-5 shadow-primary">
                  {step}
                </div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {specs.map(({ icon, label }) => (
              <div key={label} className="flex items-center gap-3 bg-slate-800 rounded-2xl p-4">
