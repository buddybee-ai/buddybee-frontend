...
export default function Contact() {
  ...
  return (
    <div className="pt-20 min-h-screen bg-gradient-to-br from-primary-50 via-white to-blue-50">
      <SEO
        path="/contact"
        title="Contact Us"
      ...
      <div className="max-w-6xl mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          {/* Form */}
          <div className="card rounded-3xl shadow-xl border border-slate-100">
            {submitted ? (
